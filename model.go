...
type Feedback struct {
	...
	AcceptanceQualityCategory string             `bson:"acceptance_quality_category,omitempty" json:"acceptance_quality_category"`
	Defect                    string             `bson:"defect,omitempty" json:"defect"`
